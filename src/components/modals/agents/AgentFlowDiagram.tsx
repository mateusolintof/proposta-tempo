...
const flowDataByAgent: Record<AgentType, { nodes: Node[]; edges: Edge[] }> = {
  ...
  faq: {
    ...
    edges: [
      { id: "e1-2", source: "1", target: "2", animated: true, style: { stroke: "#06b6d4" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#06b6d4" } },
      { id: "e2-3", source: "2", target: "3", style: { stroke: "#64748b" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#64748b" } },
      { id: "e2-4", source: "2", target: "4", style: { stroke: "#64748b" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#64748b" } },
      { id: "e2-5", source: "2", target: "5", style: { stroke: "#64748b" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#64748b" } },
      { id: "e3-6", source: "3", target: "6", style: { stroke: "#64748b" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#64748b" } },
      { id: "e4-6", source: "4", target: "6", style: { stroke: "#64748b" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#64748b" } },
      { id: "e5-6", source: "5", target: "6", style: { stroke: "#64748b" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#64748b" } },
      { id: "e6-7", source: "6", target: "7", animated: true, style: { stroke: "#10b981" }, markerEnd: { type: MarkerType.ArrowClosed, color: "#10b981" } },
